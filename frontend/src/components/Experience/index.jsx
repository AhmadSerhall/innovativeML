  ...
  return (
    <div className='experience-container flex column'>
      ...
      <div className='experience-card-container flex'>
        ...
        <CardExperience step={"step 02"} title={"Engage with Interactive Puzzles"} text={"Embark on a journey of exploration with InnovativeML that makes learning machine learning a captivating adventure. Uncover the world of code creation through engaging puzzles, where every challenge unlocks the secrets of machine learning. Our app seamlessly combines education and entertainment, transforming complex concepts into interactive, bite-sized puzzles. Discover the joy of mastering machine learning as you code your way through a fun and enlightening experience, paving the way for a future filled with technological prowess."} />
